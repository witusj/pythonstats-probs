...
Als casus nemen we een ficiteive populatie van 50.000 ondervraagden, waarvan we de volgende variabelen weten:
...
Als de nulhypothese is dat het marktaandeel van de ABN `r pDist` bedraagt en we nemen deze voor waar aan dan is de kans dat we een steekproef trekken met een proportie `r pSample` gelijk aan `r round(pValue, 6)*100`%. Hoe overtuigd ben je na je onderzoek dat de nulhypothese (en de schatting vande ABN) juist is?
