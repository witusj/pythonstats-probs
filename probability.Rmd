...
In bovenstaande grafieken zijn met rode lijnen onder- en bovengrenzen aangegeven (resp. `lbound` en `ubound`) met de waarden $\pm 4*\sqrt{k}$. Later zullen we aantonen dat de kans dat $S_k$, d.w.z. de som van uitkomsten bij een serie van $k$ worpen, kleiner is dan $2*10^{-8}$ (0.000002%). Zoals we boven kunnen zien, komt inderdaad bij geen enkele simulatie $S$ buiten de rode lijnen.
